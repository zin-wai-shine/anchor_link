...
@section('manage')
    ...
    <div class=" d-flex flex-column justify-content-center align-items-center h-100">
        ...
        <div class="current__page bg-primary px-3 d-flex align-items-center h6 mb-2">
            ...
            <div class="mx-3 text-light">/</div>
            <div  class="text-secondary text-decoration-none">Create Web Item  <i class="fa fa-list-squares"></i></div>
        </div>
        ...
        <div class="list__status bg-primary p-3">
            <div class="row h-100  p-5">
                ...
                <div class="w-100 text-center">
                    <h2 class=" text-light mb-0 text-uppercase fw-bold"> Create Web Item <i class="fa fa-link"></i></h2>
                </div>
