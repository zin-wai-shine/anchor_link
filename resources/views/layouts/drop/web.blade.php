    <div class="web__item bg-primary animate__animated animate__fadeIn animate__faster py-5 display__action" id="webItem">
        ...
        <div class="w-100 d-flex flex-column">
            @foreach(\App\Models\Category::all() as $category)
                <div class="text-primary wCategory__case category__case position-relative" id="categoryCase">
                    ...
                    <div class="type w-75 h-auto bg-primary category__child__container"
