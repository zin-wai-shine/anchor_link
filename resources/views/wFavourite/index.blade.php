                        ...
                        @forelse($favourites as $favourite)
                            @if(\Illuminate\Support\Facades\Auth::id() == $favourite->user_id)
                                @if(strlen($favourite) != 0)
                                    <div class="animate__animated animate__bounceIn  show__item__image p-0 shadow  m-1 position-relative">
                                        ...
                                        <a href="{{ $favourite->title }}" target="_blank">
                                            <img src="{{ asset('storage/webs/'.$favourite->photo) }}" class="" alt="" height="45">
                                        </a>
                                    </div>
                                @else
