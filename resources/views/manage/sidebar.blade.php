<div class="w-100 mb-5">
    ...
    <a href="" class="my-4 each__itemContainer text-decoration-none d-flex justify-content-center align-items-center">
        <div  class="text-light w-100 h-100 d-flex justify-content-between align-items-center m-0 px-4 mx-2">
...
<div class="w-100 mb-5">
    ...
    <a  href="{{ route('category.create') }}" class="my-4 text-decoration-none  each__itemContainer d-flex justify-content-center align-items-center">
        <div class="text-light w-100 d-flex justify-content-between align-items-center px-4 mx-2">
